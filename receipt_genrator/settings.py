"""
Django settings for receipt_genrator project.
...
SECRET_KEY = 'django-insecure-&%k5*d1e42qpmt^7uw$l0)chefs@8dt)(63rs#_9)t@6+kpo3s'
...
WSGI_APPLICATION = 'receipt_genrator.wsgi.application'
